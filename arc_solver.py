...
def turbo_dfs(model, logits, max_new_tokens, max_score, scores, pos, cache, start_time, end_time) -> dict:
    ...
    while time.time() - start_time < 700 and time.time() < end_time:
...
#    qwen3_module.flash_attn_func = patched_attention
    ...
    model, tokenizer = FastLanguageModel.from_pretrained(
        model_name=os.environ.get("MODEL_PATH", "/kaggle/input/qwen3_4b_grids15_sft139/transformers/bfloat16/1"),
...
#    model.config._attn_implementation = "eager"
    ...
    while not queue.empty():
        ...
        train_ds = puzzle_ds.augment(n=24, shfl_keys=True, seed=1)
...
#        model.config._attn_implementation = "eager"
        ...
        with torch.inference_mode():
            ...
            for subkeys in batches:
                ...
                if spend_time > 1600 or time.time() > end_time:
